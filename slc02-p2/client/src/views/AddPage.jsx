...
export default function AddPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const { data } = await axios.post(`${baseUrl}/groceries`, body, {
                headers: {
            ...
            navigate('/')
            Toastify({
                text: `Succeed add new grocery ${data.title}`,
                duration: 3000,
                newWindow: true,
                close: true,
    ...
    return (
        <>
            ...
            <form className="p-10 mt-5 border-2 border-black rounded-lg shadow-[2px_2px_0px_rgba(0,0,0,1)] bg-orange-300" onSubmit={handleSubmit}>
                <h1 className="text-2xl font-bold text-center mb-4">Add New Grocery</h1>
